...
2. **Read the contract + graph:** [[AGENTS]] → `02-skills/skills.registry.json`.
3. **Read context** via the filesystem (in order):
   ...
   - `03-preferences/user-preferences.md` — communication style
...
4. If frontmatter changed, regenerate `02-skills/skills.registry.json`.
