...
Load the component-audit skill from 02-skills/design-system-ops/skills/component-audit/SKILL.md and follow its complete workflow.

If the user provided a file or directory path as an argument, use that as the component source: $ARGUMENTS

Before starting the audit, read the reference material specified in the skill's frontmatter from 02-skills/design-system-ops/skills/component-audit/references/.
