...
Load the component-audit skill from /Users/sean.sands/Library/CloudStorage/GoogleDrive-hello@snds.design/My Drive/Claude Workspace/02-skills/design-system-ops/skills/component-audit/SKILL.md and follow its complete workflow.

If the user provided a file or directory path as an argument, use that as the component source: $ARGUMENTS

Before starting the audit, read the reference material specified in the skill's frontmatter from /Users/sean.sands/Library/CloudStorage/GoogleDrive-hello@snds.design/My Drive/Claude Workspace/02-skills/design-system-ops/skills/component-audit/references/.
