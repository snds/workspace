...
- 7 loose `.md` files at `02-skills/` root duplicating dir SKILL.md siblings (pending since 2026-04-21).
- `02-skills/_deprecated_workspace-bootstrap-updated_2026-04-21/` still in tree 6+ days post-rename.
- `02-skills/workspace-bootstrap/workspace-bootstrap.skill` legacy ZIP package alongside SKILL.md.
...
- P1-2: Moved 5 strict-duplicate loose files (`figma-api-router.md`, `figma-component-generation.md`, `figma-error-troubleshooting.md`, `figma-mcp-tool-usage.md`, `figma-variable-creation.md`) to `02-skills/_archive/duplicates_2026-04-27/`. Verified each is a strict subset of its dir SKILL.md before archiving.
- P1-2 (flagged for review): Left `figma-ds-generation-pipeline.md` and `figma-style-binding.md` in place — both contain content NOT present in dir SKILL.md. Flag note written at `02-skills/_archive/duplicates_2026-04-27/REVIEW-NEEDED.md` documenting unique sections and suggested actions.
- P1-3: Moved `02-skills/_deprecated_workspace-bootstrap-updated_2026-04-21/` to `02-skills/_archive/`. Confirmed against live `02-skills/workspace-bootstrap/SKILL.md` — deprecated version is the older iteration the migration audit explicitly superseded.
- P1-4: Moved `workspace-bootstrap/workspace-bootstrap.skill` (ZIP package) to `02-skills/_archive/legacy-packages/`. Live SKILL.md is the authoritative source.
...
- `02-skills/figma-ds-generation-pipeline.md` — has `ds-stack-router` Step 0 + explicit Radix scale binding map missing from dir SKILL.md. See REVIEW-NEEDED.md.
- `02-skills/figma-style-binding.md` — has Effect Style binding, Node Property binding, gradient binding, bindable-fields reference all missing from dir SKILL.md. See REVIEW-NEEDED.md.
