...
- [ ] **Curate `00-bootstrap/dist/beacon-repos.txt`** — doctor's current candidate list on Personal MBP (2026-07-09 run): `~/Projects/Davinci`, `~/Projects/Legion`, `~/Projects/MediaSentinel`, `~/Projects/Nexus`, `~/Projects/SNDS`, `~/Projects/Zuora` (earlier flagged `design-system` + `open-design` no longer present). Never list employer repos. Added 2026-07-06; candidates refreshed 2026-07-09.
