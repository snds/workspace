...
name: today
description: >
  Daily note. Carries yesterday's open tasks forward, surfaces project priorities, drafts today's
  focus. Invoked as /today or "daily note" / "plan my day".
aliases: [today]
triggers: ["/today", "daily note", "plan my day"]
tier: cross-cutting
domain: workspace
...
> Canonical home for every surface. The `.claude/skills/today/` and `.agents/skills/today/` copies (and the snds plugin's) are generated pointer wrappers (`09-tools/build-local-skill-plugin.py`); edit this file, never a wrapper.
