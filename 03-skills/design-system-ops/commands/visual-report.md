...
Load the visual-report skill from 03-skills/design-system-ops/skills/visual-report/SKILL.md and follow its complete workflow.

The user may provide audit data inline or reference previous skill outputs: $ARGUMENTS

Before starting, read the reference material specified in the skill's frontmatter from 03-skills/design-system-ops/skills/visual-report/references/.
