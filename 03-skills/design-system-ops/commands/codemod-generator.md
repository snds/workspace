...
Load the codemod-generator skill from 03-skills/design-system-ops/skills/codemod-generator/SKILL.md and follow its complete workflow.

The user should provide the migration context as an argument: $ARGUMENTS

Before starting, read the reference material specified in the skill's frontmatter from 03-skills/design-system-ops/skills/codemod-generator/references/.
