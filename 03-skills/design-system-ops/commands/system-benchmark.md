...
Load the system-benchmark skill from 03-skills/design-system-ops/skills/system-benchmark/SKILL.md and follow its complete workflow.
...
Before starting the benchmark, read the reference material specified in the skill's frontmatter from 03-skills/design-system-ops/skills/system-benchmark/references/.
