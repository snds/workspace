...
Load the system-health skill from 03-skills/design-system-ops/skills/system-health/SKILL.md and follow its complete workflow.

Before starting, read the reference material specified in the skill's frontmatter from 03-skills/design-system-ops/skills/system-health/references/.
