...
Load the drift-detection skill from 03-skills/design-system-ops/skills/drift-detection/SKILL.md and follow its complete workflow.

Before starting, read the reference material specified in the skill's frontmatter from 03-skills/design-system-ops/skills/drift-detection/references/.
