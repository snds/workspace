...
Load the token-audit skill from 03-skills/design-system-ops/skills/token-audit/SKILL.md and follow its complete workflow.
...
Before starting the audit, read the reference material specified in the skill's frontmatter from 03-skills/design-system-ops/skills/token-audit/references/.
