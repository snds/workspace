...
This command chains multiple skills into a single pre-release workflow. Load the agent instructions from 03-skills/design-system-ops/skills/component-to-release-agent.md and follow the complete pipeline.
