...
triggers: [supply chain, dependency, sbom, provenance, lockfile, secrets, secret management, hashicorp vault, ci/cd security, access token, dependabot, typosquatting]
tier: cross-cutting
