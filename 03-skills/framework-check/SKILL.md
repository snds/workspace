...
tier: cross-cutting
domain: workspace
related: [qa, close-out, failure-mode-premortem]
surfaces: ["*"]
spec_version: "2.0"
---
...
> Canonical home for every surface. The `.claude/skills/framework-check/` and `.agents/skills/framework-check/` copies (and the snds plugin's) are generated pointer wrappers (`09-tools/build-local-skill-plugin.py`); edit this file, never a wrapper.
