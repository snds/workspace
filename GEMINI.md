...
6. Durable learnings go in the vault, never Gemini memory. Vendor Canvas/Artifact/HTML panels are not durable — write the vault file (or emit a copy-ready path). Never mix this vault into employer repos.
