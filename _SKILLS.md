...
- **Visual QA:** [[03-skills/native-visual-eval/SKILL|native-visual-eval]] (native-resolution capture — the precondition; framework #10's method) + [[03-skills/visual-qa-toolkit/SKILL|visual-qa-toolkit]] (instrumented measurement) + [[03-skills/a11y-audit-toolkit/SKILL|a11y-audit-toolkit]] + [[03-skills/lead-visual-qa/SKILL|lead-visual-qa]] (judgment) + discipline lenses [[03-skills/visual-qa-dataviz/SKILL|visual-qa-dataviz]] · [[03-skills/visual-qa-motion/SKILL|visual-qa-motion]] · [[03-skills/visual-qa-type/SKILL|visual-qa-type]]
...
- **Workspace mgmt:** [[03-skills/workspace-bootstrap/SKILL|workspace-bootstrap]] (session handshake) + [[03-skills/open-agent-engine/SKILL|open-agent-engine]] (work movement — queue, ledger, receipts; lanes in [[06-context/open-engine/README|open-engine]])
