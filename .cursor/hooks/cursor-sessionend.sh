...
MSG="[ws-bootstrap/cursor-sessionend] Before yielding: (1) rewrite the active project's SESSION-STATE.md Live handoff atomically; (2) write a session fragment to $WS/06-context/sessions/<id>.md stamped Agent · Surface · Machine — do NOT append session-log.md directly; (3) leave a clear next action."
