...
- **`01-frameworks/`** — The eighteen operating frameworks (08 governs editing the workspace itself; 10 is the native-resolution perception-integrity precondition; 11 is the anticipatory failure/pre-mortem lens; 12 realtime photoreal; 13 domain rigor; 14–16 engineering / analysis / security ops; **17 living-spec agent coordination**; **18 Frost/Southleft DS×AI**).
