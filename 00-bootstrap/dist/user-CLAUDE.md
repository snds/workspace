<!-- WORKSPACE-BEACON v3 · claude · generated, do not edit -->
...
1. Read AGENTS.md at the workspace root (on chat: the Workspace project knowledge, or GitHub via a connector) and follow its read order.
