...
Every `02-skills/<name>/SKILL.md` opens with a YAML frontmatter block. These keys are
...
- **Never rename a `SKILL.md` file or its directory** without re-pointing every loader path and
  wikilink — 200+ files hardcode `02-skills/<name>/SKILL.md`. Add `aliases` instead.
